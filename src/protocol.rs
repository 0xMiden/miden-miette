...
impl SourceOffset {
    ...
    pub fn from_current_location() -> Result<(String, Self), MietteError> {
        ...
        Ok((
            loc.file().into(),
            std::fs::read_to_string(loc.file())
